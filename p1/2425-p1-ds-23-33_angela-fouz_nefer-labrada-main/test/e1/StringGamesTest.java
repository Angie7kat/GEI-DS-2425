...
public class StringGamesTest {
    ...
    @Test
    void nullCasesTests() {
        // comprueba distintos casos nulos
        assertThrows(NullPointerException.class, () -> StringGames.bestCharacters(null, "abc"));
        assertThrows(NullPointerException.class, () -> StringGames.bestCharacters("abc", null));
        assertThrows(NullPointerException.class, () -> StringGames.bestCharacters(null, null));
        assertThrows(NullPointerException.class, () -> StringGames.crossingWords(null, "abc"));
        assertThrows(NullPointerException.class, () -> StringGames.crossingWords("abc", null));
        assertThrows(NullPointerException.class, () -> StringGames.crossingWords(null, null));
        assertThrows(NullPointerException.class, () -> StringGames.wackyAlphabet(null, "abcdefghijklmnopqrstuvwxyz"));
        assertThrows(NullPointerException.class, () -> StringGames.wackyAlphabet("hello", null));
        assertThrows(NullPointerException.class, () -> StringGames.wackyAlphabet(null, null));
    }
}